...
class ContactForm extends ComponentBase
{
    ...
    public function onRun()
    {
        ...
        $this->addJs('/plugins/em/callback/assets/js/jquery.js');
        $this->addJs('/plugins/em/callback/assets/js/jquery.validate.min.js');
        $this->addJs('/plugins/em/callback/assets/js/callback.js');
    }
}
